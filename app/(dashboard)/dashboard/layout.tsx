...
import { BarChart3, ClipboardList, Users, Wrench, FileText, Settings, Menu, Shield } from 'lucide-react';
...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: '/dashboard/trabajos', icon: ClipboardList, label: 'Trabajos' },
    { href: '/dashboard/clientes', icon: Users, label: 'Clientes' },
    { href: '/dashboard/tecnicos', icon: Wrench, label: 'Tecnicos' },
